...
function applyClockSnapshot(root, snapshot = getClockSnapshot(), ids = {}) {
  ...
  const ampmStyle = ids.ampmStyle || 'font-size: 0.85rem; font-weight: 700; margin-top: 0.3rem; margin-left: 6px; color: #000000; letter-spacing: 0;';
...
window.toggleIomLock = function() {
  const pass = prompt("Enter Password to Lock/Unlock IOM:");
  if (pass === "a") {
...
function generateSidebar(activePage) {
  ...
  dashboardPages.forEach(p => {
    ...
    if (p.id === 'index') {
      ...
      const hashVal = p.id;
      clickHandler = `onclick="if(window.location.pathname.endsWith('index.html') || window.location.pathname.endsWith('/') || window.location.pathname.endsWith('.app')) { event.preventDefault(); window.location.hash = '${hashVal}'; }"`;
    }

    html += `<a href="${p.url}" ${clickHandler} class="nav-link ${specialClass} ${activePage === p.id ? 'active' : ''}" style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
...
function exportEntryReportOriginal(pageId, title) {
  ...
  header.innerHTML = `
    <div class="report-title-container" style="padding:0; flex:1;">
      <img src="data:image/png;base64," alt="MEP Logo" style="height: 70px; margin-bottom: 10px; display: block;" />
      <h2 style="color:${themeDeep}; font-size:2rem; font-weight:800; margin-bottom:4px; margin-top:0;">MEP FAN LTD.</h2>
      <div class="theme-accent-line" style="width:120px; height:3px; background:${themeMain}; margin-bottom:8px; border-radius:3px;"></div>
  ...
  applyThemeToExportRoot(clone, exportTheme);
  ...
  headers.forEach(th => {
    th.style.background = rgbaFromHex(themeSoft, 0.82);
    th.style.border = '1px solid #0f172a';
    th.style.padding = '8px';
    th.style.color = themeDeep;
  ...
  titles.forEach(h => {
    h.style.color = themeDeep;
    h.style.borderBottom = `1px solid ${themeSoft}`;
...
function buildIomDashboardReportHtml(state, period) {
  ...
  const lockAttr = isLocked ? 'disabled style="background:#eee; cursor:not-allowed;"' : '';
  let totalDaysAll = 0;
  let totalHoursAll = 0;
    ...
    <section id="iom-dashboard-report" style="background: #ffffff; color: #000000; border-radius: 8px; padding: 20px; font-family: 'Times New Roman', Times, serif;">
      <div class="ot-dashboard-header no-print" style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div class="ot-dashboard-actions no-print" style="display: flex; gap: 8px; align-items: center;">
          ...
          <button class="branch-period-btn branch-download-btn" onclick="window.toggleIomLock()" type="button" aria-label="${isLocked ? 'Unlock' : 'Lock'}" data-tip-title="${isLocked ? 'Unlock IOM' : 'Lock IOM'}" data-tip-theme="${isLocked ? 'error' : 'success'}" style="border: 1px solid ${isLocked ? '#dc2626' : '#16a34a'}; background: ${isLocked ? '#fee2e2' : '#dcfce7'}; color: ${isLocked ? '#dc2626' : '#16a34a'}; margin-left: 10px;">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${isLocked ? '<rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path>' : '<rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 9.9-1"></path>'}</svg>
          </button>
      ...
      <div class="table-container branch-table-wrap ot-dashboard-wrap" style="overflow-x: auto; max-height: none;">
        <style>
          ...
          .iom-table { width: 100%; border-collapse: collapse; font-size: 14px; color: #000; font-family: 'Times New Roman', Times, serif; }
...
function exportReportOriginal() {
  ...
  applyThemeToExportRoot(container, exportTheme);
  applyThemeToExportRoot(clone, exportTheme);
  clone.style.background = getThemeBackground(exportTheme, 0.2);
  ...
  clone.querySelectorAll('.theme-accent-line').forEach(line => {
    line.style.background = `linear-gradient(90deg, ${themeMain} 0%, transparent 80%)`;
  });
...
const THEMES = [
  { id: 'amber',        name: 'Golden Amber',    desc: 'Sunlit gold plate',        swatch: 'linear-gradient(135deg, #fde68a, #f59e0b)',    palette: ['#fde68a','#f59e0b','#92400e'], bg: ['#fffbeb','#fef3c7','#fcd34d'], contrast: '#422006' },
  { id: 'ocean',        name: 'Deep Ocean',      desc: 'Blue sea plate',           swatch: 'linear-gradient(135deg, #bae6fd, #0284c7)',    palette: ['#bae6fd','#0284c7','#075985'], bg: ['#f0f9ff','#bae6fd','#38bdf8'], contrast: '#f0f9ff' },
  { id: 'rose',         name: 'Rose Garden',     desc: 'Pink flower plate',        swatch: 'linear-gradient(135deg, #ffe4e6, #fb7185)',    palette: ['#ffe4e6','#fb7185','#9f1239'], bg: ['#fff1f2','#ffe4e6','#fda4af'], contrast: '#4c0519' },
  { id: 'emerald',      name: 'Emerald Forest',  desc: 'Forest green plate',       swatch: 'linear-gradient(135deg, #bbf7d0, #22c55e)',    palette: ['#bbf7d0','#22c55e','#14532d'], bg: ['#f0fdf4','#dcfce7','#86efac'], contrast: '#052e16' },
  { id: 'purple',       name: 'Imperial Violet', desc: 'Royal violet plate',       swatch: 'linear-gradient(135deg, #ede9fe, #7c3aed)',    palette: ['#ede9fe','#7c3aed','#4c1d95'], bg: ['#faf5ff','#ede9fe','#c4b5fd'], contrast: '#ffffff' },
  { id: 'mint',         name: 'Mint Fresh',      desc: 'Teal mint plate',          swatch: 'linear-gradient(135deg, #ccfbf1, #14b8a6)',    palette: ['#ccfbf1','#14b8a6','#134e4a'], bg: ['#f0fdfa','#ccfbf1','#5eead4'], contrast: '#042f2e' },
  { id: 'sunset',       name: 'Sunset Flame',    desc: 'Burnt orange plate',       swatch: 'linear-gradient(135deg, #fed7aa, #ea580c)',    palette: ['#fed7aa','#ea580c','#7c2d12'], bg: ['#fff7ed','#fed7aa','#fdba74'], contrast: '#431407' },
  { id: 'arctic',       name: 'Arctic Ice',      desc: 'Cyan frost plate',         swatch: 'linear-gradient(135deg, #ecfeff, #06b6d4)',    palette: ['#ecfeff','#06b6d4','#164e63'], bg: ['#ecfeff','#cffafe','#67e8f9'], contrast: '#083344' },
  { id: 'lavender',     name: 'Lilac Bloom',     desc: 'Magenta lilac plate',      swatch: 'linear-gradient(135deg, #f5d0fe, #d946ef)',    palette: ['#f5d0fe','#d946ef','#701a75'], bg: ['#fdf4ff','#fae8ff','#f0abfc'], contrast: '#4a044e' },
  ...
  { id: 'watermelon',   name: 'Watermelon Pop',  desc: 'Red green plate',          swatch: 'linear-gradient(135deg, #dcfce7, #ef4444)',    palette: ['#dcfce7','#ef4444','#14532d'], bg: ['#f0fdf4','#fee2e2','#f87171'], contrast: '#ffffff' },
  { id: 'parrot',       name: 'Neon Parrot',     desc: 'Electric lime plate',      swatch: 'linear-gradient(135deg, #f0fdf4, #bef264)',    palette: ['#f0fdf4','#bef264','#166534'], bg: ['#f0fdf4','#d9f99d','#86efac'], contrast: '#14532d' },
  { id: 'indigo-night', name: 'Indigo Night',    desc: 'Deep indigo plate',        swatch: 'linear-gradient(135deg, #c7d2fe, #4f46e5)',    palette: ['#c7d2fe','#4f46e5','#312e81'], bg: ['#eef2ff','#c7d2fe','#818cf8'], contrast: '#ffffff' },
...
function getActiveTheme() {
  const themeId = document.body.getAttribute('data-theme') || localStorage.getItem('mep_theme') || 'rose';
...
function applyThemeToExportRoot(root, theme) {
  ...
  root.style.setProperty('--total-bg', rgbaFromHex(soft, 0.72));
  root.style.setProperty('--total-text', deep);
  root.style.setProperty('--theme-contrast', theme.contrast || '#fff');
...
function setTheme(themeId) {
  ...
  const selectedTheme = THEMES.find(t => t.id === themeId) || THEMES.find(t => t.id === 'rose');
...
function generateAndDownloadCompleteMonthlyExcel(monthKey, results) {
  ...
  <table border="1" style="border-collapse: collapse; font-family: 'Times New Roman', Times, serif; font-size: 11pt;">
    <thead>
      <tr>
        <th colspan="${2 + dates.length * 4 + 6}" style="font-size: 18pt; font-weight: bold; text-align: center; padding: 12px; background-color: #000000; color: #ffffff; border: 1px solid #334155;">
          Complete Attendance Efficiency Report - ${monthInfo.displayName}
        </th>
      </tr>
      <tr>
        <th rowspan="2" style="background-color: #000000; color: #ffffff; font-weight: bold; vertical-align: middle; text-align: center; border: 1px solid #334155; padding: 6px;">Section</th>
        <th rowspan="2" style="background-color: #000000; color: #ffffff; font-weight: bold; vertical-align: middle; text-align: center; border: 1px solid #334155; padding: 6px;">Designation</th>`;
        
  dates.forEach(dStr => {
    const d = new Date(dStr);
    const dateLabel = d.toLocaleDateString('en-GB', { day: 'numeric', month: 'short' });
    const isFriday = d.getDay() === 5;
    const bgColor = isFriday ? '#dc2626' : '#2563eb';
    const borderColor = isFriday ? '#991b1b' : '#1e3a8a';
    html += `<th colspan="4" style="background-color: ${bgColor}; color: #ffffff; font-weight: bold; text-align: center; border: 1px solid ${borderColor}; padding: 6px;">${dateLabel}</th>`;
  });
  
  html += `<th colspan="6" style="background-color: #4f46e5; color: #ffffff; font-weight: bold; text-align: center; border: 1px solid #312e81; padding: 6px;">Monthly Total / Average</th>
      </tr>
      <tr>`;
      
  dates.forEach((dStr) => {
    const isFriday = new Date(dStr).getDay() === 5;
    const authBg = isFriday ? '#fecaca' : '#e2e8f0';
    const existBg = isFriday ? '#f87171' : '#cbd5e1';
    html += `<th style="background-color: ${authBg}; color: #000000; text-align: center; border: 1px solid #94a3b8; padding: 4px; font-size: 10pt;">Auth</th>
             <th style="background-color: ${existBg}; color: #000000; text-align: center; border: 1px solid #94a3b8; padding: 4px; font-size: 10pt;">Exist</th>
             <th style="background-color: #bbf7d0; color: #14532d; text-align: center; border: 1px solid #86efac; padding: 4px; font-size: 10pt;">Pres</th>
             <th style="background-color: #fecaca; color: #7f1d1d; text-align: center; border: 1px solid #fca5a5; padding: 4px; font-size: 10pt;">Abs</th>`;
  });
  
  html += `<th style="background-color: #e0e7ff; color: #000000; text-align: center; border: 1px solid #c7d2fe; padding: 4px; font-size: 10pt;">Avg Auth</th>
           <th style="background-color: #c7d2fe; color: #000000; text-align: center; border: 1px solid #a5b4fc; padding: 4px; font-size: 10pt;">Avg Exist</th>
           <th style="background-color: #bbf7d0; color: #14532d; text-align: center; border: 1px solid #86efac; padding: 4px; font-size: 10pt;">Avg Pres</th>
           <th style="background-color: #fecaca; color: #7f1d1d; text-align: center; border: 1px solid #fca5a5; padding: 4px; font-size: 10pt;">Avg Abs</th>
           <th style="background-color: #000000; color: #f8fafc; text-align: center; border: 1px solid #334155; padding: 4px; font-size: 10pt;">Pres %</th>
           <th style="background-color: #000000; color: #f8fafc; text-align: center; border: 1px solid #334155; padding: 4px; font-size: 10pt;">Abs %</th>
      </tr>
    </thead>
    <tbody>`;
  ...
  Object.keys(dataMap).sort().forEach(section => {
    ...
    designations.forEach((desig, index) => {
      html += `<tr>`;
      if (index === 0) {
        html += `<td rowspan="${rowSpanCount}" style="vertical-align: middle; background-color: #f8fafc; color: #000000; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; font-weight: bold; font-size: 11pt;">${section}</td>`;
      }
      html += `<td style="background-color: #ffffff; color: #000000; border: 1px solid #94a3b8; padding: 5px; font-weight: 500;">${desig}</td>`;
      ...
      dates.forEach(dStr => {
        ...
        if (cell) {
          html += `<td style="text-align: center; border: 1px solid #cbd5e1; padding: 4px; color: #000000; background-color: #ffffff; mso-number-format:'0';">${cell.auth}</td>
                   <td style="text-align: center; border: 1px solid #cbd5e1; padding: 4px; color: #000000; background-color: #f8fafc; mso-number-format:'0';">${cell.exist}</td>
                   <td style="text-align: center; border: 1px solid #cbd5e1; padding: 4px; color: #166534; font-weight: bold; background-color: #f0fdf4; mso-number-format:'0';">${cell.pres}</td>
                   <td style="text-align: center; border: 1px solid #cbd5e1; padding: 4px; color: #991b1b; font-weight: bold; background-color: #fef2f2; mso-number-format:'0';">${cell.abs}</td>`;
          ...
          html += `<td style="text-align: center; border: 1px solid #cbd5e1; color: #cbd5e1; background-color: #f8fafc;">-</td>
                   <td style="text-align: center; border: 1px solid #cbd5e1; color: #cbd5e1; background-color: #f8fafc;">-</td>
                   <td style="text-align: center; border: 1px solid #cbd5e1; color: #cbd5e1; background-color: #f8fafc;">-</td>
                   <td style="text-align: center; border: 1px solid #cbd5e1; color: #cbd5e1; background-color: #f8fafc;">-</td>`;
        }
      });
      ...
      const absPct = rowExistSum > 0 ? Math.round((rowAbsSum / rowExistSum) * 100) : 0;
      
      const rawAvgPct = rowExistSum > 0 ? (rowPresSum / rowExistSum) : 0;
      const rawAbsPct = rowExistSum > 0 ? (rowAbsSum / rowExistSum) : 0;
      
      html += `<td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #000000; background-color: #e0e7ff; mso-number-format:'0';">${avgAuth}</td>
               <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #000000; background-color: #c7d2fe; mso-number-format:'0';">${avgExist}</td>
               <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #14532d; background-color: #bbf7d0; mso-number-format:'0';">${avgPres}</td>
               <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #7f1d1d; background-color: #fecaca; mso-number-format:'0';">${avgAbs}</td>
               <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #ffffff; background-color: ${avgPct >= 90 ? '#10b981' : avgPct >= 75 ? '#f59e0b' : '#ef4444'}; mso-number-format:'0%';">${rawAvgPct}</td>
               <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #ffffff; background-color: ${absPct >= 20 ? '#ef4444' : absPct >= 10 ? '#f59e0b' : '#10b981'}; mso-number-format:'0%';">${rawAbsPct}</td>
             </tr>`;
    });

    // Section Total Row with thick border
    html += `<tr>`;
    html += `<td style="background-color: #e2e8f0; color: #000000; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; font-weight: bold; font-style: italic; text-align: right;">Total</td>`;
    
    let secAuthTotal = 0, secExistTotal = 0, secPresTotal = 0, secAbsTotal = 0;
    dates.forEach(dStr => {
      const t = sectionTotals[dStr];
      html += `<td style="text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; font-weight: bold; background-color: #f1f5f9; color: #000000; mso-number-format:'0';">${t.auth}</td>
               <td style="text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; font-weight: bold; background-color: #e2e8f0; color: #000000; mso-number-format:'0';">${t.exist}</td>
               <td style="text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; font-weight: bold; background-color: #d1fae5; color: #065f46; mso-number-format:'0';">${t.pres}</td>
               <td style="text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; font-weight: bold; background-color: #fee2e2; color: #991b1b; mso-number-format:'0';">${t.abs}</td>`;
      secAuthTotal += t.auth;
    ...
    html += `<td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; color: #000000; background-color: #e0e7ff; mso-number-format:'0';">${sAvgAuth}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; color: #000000; background-color: #c7d2fe; mso-number-format:'0';">${sAvgExist}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; color: #14532d; background-color: #bbf7d0; mso-number-format:'0';">${sAvgPres}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; color: #7f1d1d; background-color: #fecaca; mso-number-format:'0';">${sAvgAbs}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; color: #ffffff; background-color: #000000; mso-number-format:'0%';">${sRawPct}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; border-bottom: 2px solid #0f172a; padding: 5px; color: #ffffff; background-color: #000000; mso-number-format:'0%';">${sRawAbsPct}</td>
           </tr>`;
  ...
  // Daily Totals Row
  html += `<tr>
    <td colspan="2" style="font-weight: bold; text-align: right; border: 1px solid #1e293b; padding: 8px; color: #ffffff; background-color: #000000;">GRAND DAILY TOTALS</td>`;
  ...
  dates.forEach(dStr => {
    ...
    html += `<td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 6px; color: #000000; background-color: #e2e8f0;">${t.auth}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 6px; color: #000000; background-color: #cbd5e1;">${t.exist}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #86efac; padding: 6px; color: #14532d; background-color: #86efac;">${t.pres}</td>
             <td style="font-weight:bold; text-align: center; border: 1px solid #fca5a5; padding: 6px; color: #7f1d1d; background-color: #fca5a5;">${t.abs}</td>`;
  });
  
  const numDates = dates.length;
  const oAvgAuth = numDates > 0 ? Math.round(overallAuth / numDates) : 0;
  const oAvgExist = numDates > 0 ? Math.round(overallExist / numDates) : 0;
  const oAvgPres = numDates > 0 ? Math.round(overallPres / numDates) : 0;
  const oAvgAbs = numDates > 0 ? Math.round(overallAbs / numDates) : 0;
  const oAvgPct = overallExist > 0 ? Math.round((overallPres / overallExist) * 100) : 0;
  const oAbsPct = overallExist > 0 ? Math.round((overallAbs / overallExist) * 100) : 0;
  
  html += `<td style="font-weight:bold; text-align: center; border: 1px solid #000000; padding: 6px; background-color: #94a3b8; color: white; mso-number-format:'0';">${oAvgAuth}</td>
           <td style="font-weight:bold; text-align: center; border: 1px solid #000000; padding: 6px; background-color: #94a3b8; color: white; mso-number-format:'0';">${oAvgExist}</td>
           <td style="font-weight:bold; text-align: center; border: 1px solid #000000; padding: 6px; background-color: #059669; color: white; mso-number-format:'0';">${oAvgPres}</td>
           <td style="font-weight:bold; text-align: center; border: 1px solid #000000; padding: 6px; background-color: #e11d48; color: white; mso-number-format:'0';">${oAvgAbs}</td>
           <td style="font-weight:bold; text-align: center; border: 1px solid #000000; padding: 6px; background-color: #94a3b8; color: white; mso-number-format:'0%';">${oAvgPct/100}</td>
           <td style="font-weight:bold; text-align: center; border: 1px solid #000000; padding: 6px; background-color: #94a3b8; color: white; mso-number-format:'0%';">${oAbsPct/100}</td>
         </tr>`;
  ...
  html += `<tr>
        <td colspan="2" rowspan="2" style="background-color: #000000; color: #ffffff; font-weight: bold; vertical-align: middle; text-align: center; border: 1px solid #334155; padding: 6px;">Designation</td>`;
  ...
  Object.keys(desigTotals).sort().forEach(desig => {
    ...
    html += `<tr><td colspan="2" style="background-color: #f8fafc; color: #000000; border: 1px solid #94a3b8; padding: 5px; font-weight: bold; font-size: 11pt;">${desig}</td>`;
    ...
    const aAuth = dCount > 0 ? Math.round(rAuth / dCount) : 0;
    const aExist = dCount > 0 ? Math.round(rExist / dCount) : 0;
    const aPres = dCount > 0 ? Math.round(rPres / dCount) : 0;
    const aAbs = dCount > 0 ? Math.round(rAbs / dCount) : 0;
    const rawPct = rExist > 0 ? (rPres / rExist) : 0;
    const rawAbsPct = rExist > 0 ? (rAbs / rExist) : 0;
    
    html += `<td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #000000; background-color: #e0e7ff; mso-number-format:'0';">${aAuth}</td>
              <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #000000; background-color: #c7d2fe; mso-number-format:'0';">${aExist}</td>
              <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #14532d; background-color: #bbf7d0; mso-number-format:'0';">${aPres}</td>
              <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #7f1d1d; background-color: #fecaca; mso-number-format:'0';">${aAbs}</td>
              <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #ffffff; background-color: ${(rawPct*100) >= 90 ? '#10b981' : (rawPct*100) >= 75 ? '#f59e0b' : '#ef4444'}; mso-number-format:'0%';">${rawPct}</td>
              <td style="font-weight:bold; text-align: center; border: 1px solid #94a3b8; padding: 5px; color: #ffffff; background-color: ${(rawAbsPct*100) >= 20 ? '#ef4444' : (rawAbsPct*100) >= 10 ? '#f59e0b' : '#10b981'}; mso-number-format:'0%';">${rawAbsPct}</td>
            </tr>`;
  });
